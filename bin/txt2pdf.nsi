...
VIProductVersion "11.1.0.0"
VIAddVersionKey "CompanyName" "SANFACE Software"
VIAddVersionKey "FileVersion" "11.1.0.0"
VIAddVersionKey "FileDescription" "txt2pdf 11.1 Self-Extract Setup"
VIAddVersionKey "InternalName" "txt2pdf.exe"
VIAddVersionKey "LegalCopyright" "1999-2017 SANFACE Software"
...
VIAddVersionKey "ProductVersion" "11.1.0.0"
...
;Pages
  ...
  !define MUI_FINISHPAGE_LINK "Visit the SANFACE Software site"
  !define MUI_FINISHPAGE_LINK_LOCATION "http://www.sanface.com/"
...
SectionIn RO
  ...
  File Docs\*.*
  SetOutPath $INSTDIR\TrueType\codepage437
  File Languages\czech\*.*
  SetOutPath $INSTDIR\Languages\czech
  File Languages\czech\*.*
  SetOutPath $INSTDIR\Languages\greek
  File Languages\greek\*.*
  SetOutPath $INSTDIR\Languages\hebrew
  File Languages\hebrew\*.*
  ...
  File Languages\thai\*.*
  SetOutPath $INSTDIR\Languages\cyrillic
  File Languages\cyrillic\*.*
