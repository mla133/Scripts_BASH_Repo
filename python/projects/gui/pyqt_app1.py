...
class PushBut1(QtWidgets.QPushButton):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background-color: rgba(1,255,0,100);color: rgba(1,140,0,100);")
        self.setStyleSheet("border-style: solid;border-radius: 3px; border-width: 0.5px;border-color: rgba(1,140,0,100);")
   
    def enterEvent(self, event):
        self.setStyleSheet("margin: 1px; padding: 7px;")
        self.setStyleSheet("background- color: rgba(1,140,040,100);color: rgba(1,140,255,100);")
        self.setStyleSheet("border-style: solid; border-radius: 3px;border-width: 0.5px;border-color: rgba(1,140,140,100);")
...
class PyQtApp(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.textf.setStyleSheet("background-color: rgba(1,255,0,100);color: rgba(1,140,0,100);")
        self.textf.setStyleSheet("border-style: solid; border-radius: 3px;border-width: 0.5px;border-color: rgba(1,140,0,100);")
                                 
        self.but1 = PushBut1(self)
        self.but1.setText("Text Border - Blue")
        self.but1.setFixedWidth(150)
        self.but1.setFont(font_but)
        self.but2 = PushBut1(self)
        self.but2.setText("Image")
    ...
    def on_but1(self):
        ...
        self.textf.setStyleSheet("border-style: solid; border-radius: 3px; border-width: 0.5px; border-color: rgba(0,140,255,255);")
