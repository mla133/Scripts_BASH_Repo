...
print("BatchGV\t\Add5 vol/inj\tAdd5 rate\tAdd5 #inj\tAdd5 Vol");
...
while True:
    ...
    if c.is_open():
        ...
        print(str(trans_GV) + "\t" + str(add5_rate) + str(add5_curinj) + str(add5_vol) + "\t" + str(add6_rate) + str(add6_curinj) + str(add6_vol) + "\t" + str(add7_rate) + str(add7_curinj) + str(add7_vol))
