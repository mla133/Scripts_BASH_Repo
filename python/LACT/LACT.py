...
c = FloatModbusClient(host='192.168.181.206', port=502, auto_open=True)
...
double_AccuIV = d.read_double(4480, 1)
double_AccuGV = d.read_double(4484, 1)
double_AccuGST = d.read_double(4488, 1)
double_AccuGSV = d.read_double(4492, 1)
...
with open('LACT_data.csv','a') as LACT_data:
    ...
    LACT_data_writer.writerow(['   ', 'MicroFlow', 'AccuLoad', 'LACT', 'Omni', 'Spirit', 'Time'])
